...
Figure \ref{fig:plpjumppoint} demonstrates the intensity function
...
\caption{Intensity function, time to SCEs, and rest time within a shift in a PLP intensity function, $\beta = 1.2$, $\theta=2$}\label{fig:plpjumppoint}
\end{figure}
...
\caption{Intensity function, time to SCEs, and rest time within a shift with a jump-point PLP, $\beta = 1.2$, $\theta=2$}\label{fig:plpnhpp}
\end{figure}
