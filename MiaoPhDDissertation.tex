...
{\centering \includegraphics[width=0.6\linewidth]{figs/NHPP_arrow_plot} 
...
\item
  ...
  \item
    Predictive models: a) Bayesian models, b) Hierarchical models, c) Markov chain Monte Carlo (MCMC)
  \item
    Scalable Bayesian models: a) Hamiltonian Monte Carlo (HMC), b) Subsampling MCMC
  \end{enumerate}
\item
