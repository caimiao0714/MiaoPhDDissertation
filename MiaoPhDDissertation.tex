...
\caption{\label{tab:analysis30int}A demonstration of 30 minutes intervals data for hierarchical logistic and Poisson regression}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}{ccccccccc}
\toprule
driver & shift\_ID & shift\_start & shift\_end & shift\_length & interval\_id & n\_SCE & SCE\_time & SCE\_type\\
\midrule
