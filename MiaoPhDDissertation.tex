...
In order to make the MCMC estimation in Bayesian models tractable, I will use the following data reduction algorithms to aggregate real-time ping data to \emph{trips} and \emph{shifts}:

\begin{itemize}
\item
  For each of the truck drivers, if the ping data showed that the truck was not moving for more than 20 minutes, the ping data will be separated into two different \emph{trips}.
\item
...
\subsection{Likelihood function of a NHPP}\label{likelihood-function-of-a-nhpp}}
