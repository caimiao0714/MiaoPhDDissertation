...
fit0 = stan("Stan/jplp_hierarchical_kappa02.stan",
...
start_time = Sys.time()
fit_JPLP = stan("Stan/jplp_hierarchical_kappa02.stan", data = dt_JPLP, seed = 123,
                chains = nchains, cores = 4, iter = 5000, 
                warmup = warm_up_iter, refresh = 1)
(Time_diff = Sys.time() - start_time)
broom::tidy(fit_JPLP, conf.int = T, rhat = T, ess = T)
saveRDS(fit_JPLP, 'Fit/fit_JPLP_496_HB_kappa02.rds')
...
(Time_diff = Sys.time() - start_time)
broom::tidy(fit_JPLP, conf.int = T, rhat = T, ess = T)
saveRDS(fit_JPLP, 'Fit/fit_JPLP_496_HW_kappa02.rds')
...
(Time_diff = Sys.time() - start_time)
broom::tidy(fit_JPLP, conf.int = T, rhat = T, ess = T)
saveRDS(fit_JPLP, 'Fit/fit_JPLP_496_CM_kappa02.rds')
...
(Time_diff = Sys.time() - start_time)
broom::tidy(fit_JPLP, conf.int = T, rhat = T, ess = T)
saveRDS(fit_JPLP, 'Fit/fit_JPLP_496_CM_RS_kappa02.rds')
