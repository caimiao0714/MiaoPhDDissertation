...
pacman::p_load(dplyr, data.table, ggplot2, sf, viridis, wesanderson, cowplot, ggthemes, colorspace, ggtext)
  ...
  z = ggplot() +
    ...
    labs(x = NULL, y = NULL,
         title = paste0("Geographical distribution of ", moving,
                        " pings by the 496 truck drivers 2015-2016"),
         caption = "This is based on NDS ping data from 496 regional truck drivers in the United States.") +
    theme_map(
