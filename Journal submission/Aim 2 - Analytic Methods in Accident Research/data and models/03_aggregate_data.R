...
ce_int30 = fst::read_fst("data/cleaned/31interval30_CE.fst") %>% as.data.table()
ce_int60 = fst::read_fst("data/cleaned/32interval60_CE.fst") %>% as.data.table()
...
ce_int60_11 = ce_int60 %>% 
  .[,max_drive := sum(interval_time), .(driver, shift_id)] %>% 
  .[max_drive <= 11*60]
fst::write_fst(ce_int30_11, "data/cleaned/32interval30_CE_11hours_limit.fst")
fst::write_fst(ce_int60_11, "data/cleaned/32interval60_CE_11hours_limit.fst")
data.table::fwrite(ce_int30_11, "data/cleaned/32interval30_CE_11hours_limit.csv")
data.table::fwrite(ce_int60_11, "data/cleaned/32interval60_CE_11hours_limit.csv")