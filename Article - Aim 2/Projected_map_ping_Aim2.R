...
pnoroad = function(dt, viridis_color = "magma", moving = "moving"){
  z = ggplot() +
    ...
    guides(fill = guide_legend(title = "Number of pings",
                               override.aes = list(alpha = 1, size = 2))) +
    labs(x = NULL, y = NULL,
         title = paste0("Geographical distribution of the **", moving,
                        " pings** generated by the 497 truck drivers, 2015-2016"),
         caption = "The drivers were employees in large commercial truck company in the United States") +
    theme_map(plot.title = element_markdown(size = 15, hjust = 0.5,
