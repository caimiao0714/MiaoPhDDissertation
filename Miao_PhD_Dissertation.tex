...
The most commonly used statistical models for traffic safety are logistic regression (Model \eqref{eq:logit}) and Poisson regression (Model \eqref{eq:poisson}).
