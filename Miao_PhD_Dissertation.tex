...
I used the \textbf{knitr}\index{knitr} package and the \textbf{bookdown}\index{bookdown} package to compile my book \citep{xie2014, R-bookdown}. My R session information is shown below:
