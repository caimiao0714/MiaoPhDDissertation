...
We retrieved weather variables from the DarkSky API.
...
\hypertarget{data-query}{%
\section*{Data query}\label{data-query}}
...
\hypertarget{road-geometry-data}{%
\subsection*{Road geometry data}\label{road-geometry-data}}
