...
I hypothesize that **between-trip rest time** can recover the intensity function by some proportion, and intensity function varies significantly from drivers to drivers.
...
Although I will use the OSC server that has Random-Access Memory (RAM) of more than 500 GB, it may still be hard and slow to read and process this giant file. 
