...
A commonly used reliability model is the *Nonhomogeneous Poisson Process (NHPP)*. It is a Poisson process whose intensity function is non-constant. The Power law process (PLP) is a special case of a NHPP when the intensity function is:
\begin{equation}
