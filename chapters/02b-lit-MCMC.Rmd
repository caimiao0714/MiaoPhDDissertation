...
There are several strengths of Bayesian models over traditional Frequentist models.

- Intuitive interpretation and model comparison. Posterior predictive distribution.
- Prior
- Sparse data
- Model flexibility
