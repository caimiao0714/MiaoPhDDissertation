...
The most commonly used statistical models for traffic safety are logistic regression (Model \@ref(eq:logit)) and Poisson regression (Model \@ref(eq:poisson)).

\begin{equation}
\begin{split}
Y_i & \sim \text{Bernoulli}(p_i) \\
\text{logit}(\frac{p_i}{1 - p_i}) & = \beta_0 + \beta_1x_1 + \beta_2x_2 + \cdots + \beta_kx_k
(\#eq:logit)
\end{split}
\end{equation}
