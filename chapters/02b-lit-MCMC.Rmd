...
### Hamiltonian Markov Chain simulation

Random walk M-H algorithm can have very low acceptance rates and thus be very inefficient when there is correlation between parameters or the parameter space has high curvature.
