...
Random walk M-H algorithm can have very low acceptance rates and thus be very inefficient when there is correlation between parameters or the parameter space has high curvature. The Hamiltonian Monte Carlo changes the random-walk behavior into a non-random-walk one by adding auxiliary momentum parameters $p_n$ [@betancourt2017conceptual]. 
