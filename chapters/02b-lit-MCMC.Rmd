...
**Explain or to predict** @shmueli2010explain; @breiman2001statistical.

The most commonly used statistical models for traffic safety are logistic regression and Poisson regression.

The parameterization of a logistic regression is shown in Model \@ref(eq:logit).
...
The parameterization of a Poisson regression is shown in Model \@ref(eq:poisson).
\begin{equation}
\begin{split}
...
The HMC is essentially an improved form of M-H algorithm by using the Hamiltonian to generate effective proposals instead of naive random-walk and revised form of the acceptance probability (Equation \@ref(eq:hmc)).
