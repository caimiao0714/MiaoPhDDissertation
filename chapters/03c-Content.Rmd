...
* Chapter 2: Literature review
    ...
    5. Predictive models: a) Bayesian models, b) Hierarchical models, c) Markov chain Monte Carlo (MCMC)
    6. Scalable Bayesian models: a) Hamiltonian Monte Carlo (HMC), b) Subsampling MCMC
